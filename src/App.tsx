          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div className="grid grid-cols-3 gap-2.5 sm:gap-4 flex-grow max-w-xl">
                <div className="bg-slate-100/90 p-3.5 rounded-xl border border-slate-300">
                  <span className="text-[10px] font-black text-slate-600 uppercase tracking-wider block"><strong>Total Siswa</strong></span>
                  <span className="text-base sm:text-lg font-black text-slate-900 block mt-0.5">{totalStudents}</span>
                </div>
                <div className="bg-emerald-100/90 p-3.5 rounded-xl border border-emerald-300">
                  <span className="text-[10px] font-black text-emerald-800 uppercase tracking-wider block"><strong>Siswa Valid</strong></span>
                  <span className="text-base sm:text-lg font-black text-emerald-900 block mt-0.5">{validStudentsCount}</span>
                </div>
                <div className="bg-red-100/90 p-3.5 rounded-xl border border-red-300">
                  <span className="text-[10px] font-black text-red-800 uppercase tracking-wider block"><strong>Butuh Solusi</strong></span>
                  <span className="text-base sm:text-lg font-black text-red-900 block mt-0.5">{invalidStudentsCount}</span>
                </div>
              </div>

              {/* TAB SELECTOR */}
              <nav className="flex space-x-1 bg-slate-100 border border-slate-200 p-1 rounded-xl self-start md:self-auto" id="main-navigation-tabs">
                <button
                  id="tab-students"
                  onClick={() => {
                ...
                >
                  ...
                  <span className="font-extrabold">Basis Data Siswa</span>
                </button>
                ...
                >
                  ...
                  <span className="font-extrabold">Profil Sekolah</span>
                </button>
                ...
                >
                  ...
                  <span className="font-extrabold">Kelola Admin</span>
                </button>
              </nav>
            </div>
          </div>
